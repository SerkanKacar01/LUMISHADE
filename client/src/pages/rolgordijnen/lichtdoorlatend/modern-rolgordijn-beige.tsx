...
export default function ModernRolgordijnBeigePage() {
  ...
  const handleAddToCart = () => {
    console.log("Adding to cart:", {
      product: "Modern Rolgordijn Beige",
      quantity,
      operatingSide,
        ...
        <div className="bg-white shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <h1 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Modern Rolgordijn Beige
            </h1>
            <p className="text-lg text-gray-600">
              Stijlvol beige rolgordijn met moderne uitstraling voor een warme sfeer in uw interieur.
            </p>
          </div>
        </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-center gap-2">
                    ...
                    Lichtdoorlatende stof voor zachte lichtinval
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-primary rounded-full"></span>
                    Moderne beige kleur
