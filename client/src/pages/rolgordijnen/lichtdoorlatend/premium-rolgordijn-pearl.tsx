...
export default function PremiumRolgordijnPearlPage() {
  ...
  const handleAddToCart = () => {
    console.log("Adding to cart:", {
      product: "Premium Rolgordijn Pearl",
      quantity,
      operatingSide,
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-8">
            <div className="space-y-6">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">
                Premium Rolgordijn Pearl
              </h1>
              <div className="aspect-w-16 aspect-h-12 lg:aspect-w-4 lg:aspect-h-3">
                <img
                  src="https://images.unsplash.com/photo-1615873968403-89e068629265?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                  alt="Premium Rolgordijn Pearl"
