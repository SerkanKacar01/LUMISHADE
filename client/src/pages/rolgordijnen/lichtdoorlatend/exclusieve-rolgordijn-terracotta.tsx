...
export default function ExclusieveRolgordijnTerracottaPage() {
  ...
  const handleAddToCart = () => {
    console.log("Adding to cart:", {
      product: "Exclusieve Rolgordijn Terracotta",
      quantity,
      operatingSide,
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-8">
            <div className="space-y-6">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">
                Exclusieve Rolgordijn Terracotta
              </h1>
              <div className="aspect-w-16 aspect-h-12 lg:aspect-w-4 lg:aspect-h-3">
                <img
                  ...
                  alt="Exclusieve Rolgordijn Terracotta"
