...
export default function EleganteBlackoutGrijsPage() {
  ...
  const handleAddToCart = () => {
    console.log("Adding to cart:", {
      product: "Elegante Blackout Grijs",
      quantity,
      operatingSide,
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-8">
            <div className="space-y-6">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">
                Elegante Blackout Grijs
              </h1>
              <div className="aspect-w-16 aspect-h-12 lg:aspect-w-4 lg:aspect-h-3">
                <img
                  src="https://images.unsplash.com/photo-1568010434570-74e9ba7126b5?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80"
                  alt="Elegante Blackout Grijs"
            ...
            <div className="space-y-4">
              ...
              <div className="mt-3 mb-4 text-center md:hidden">
                <p className="text-sm text-gray-500">
                  Veeg naar links of rechts om je gewenste breedte te selecteren.
                </p>
              </div>
