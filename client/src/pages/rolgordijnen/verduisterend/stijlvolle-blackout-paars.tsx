...
export default function StijlvolleBlackoutPaarsPage() {
  ...
  const handleAddToCart = () => {
    console.log("Adding to cart:", {
      product: "Stijlvolle Blackout Paars",
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-8">
            <div className="space-y-6">
              <h1 className="text-3xl lg:text-4xl font-bold text-gray-900">Stijlvolle Blackout Paars</h1>
              <div className="aspect-w-16 aspect-h-12 lg:aspect-w-4 lg:aspect-h-3">
                <img src="https://images.unsplash.com/photo-1631678444745-89e9c0366ba6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=800&q=80" alt="Stijlvolle Blackout Paars" className="w-full h-64 lg:h-80 object-cover rounded-lg" />
              </div>
