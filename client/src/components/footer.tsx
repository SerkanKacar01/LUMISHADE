          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-gray-400 mb-3 sm:mb-4 text-sm sm:text-base leading-relaxed">
                Premium kant-en-klare raamdecoraties - Kwaliteitsoplossingen
                voor ALLE woningen.
              </p>
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="space-y-2 text-gray-400 text-sm sm:text-base">
                <p className="flex items-center min-h-[44px]">
                  <Phone className="w-4 h-4 mr-2 flex-shrink-0" />
                  +31 20 123 4567
                </p>
                <p className="flex items-center min-h-[44px]">
                  <Mail className="w-4 h-4 mr-2 flex-shrink-0" />
                  info@sunshadeandco.eu
                </p>
                <p className="flex items-start min-h-[44px]">
                  <MapPin className="w-4 h-4 mr-2 flex-shrink-0 mt-1" />
                  123 Window Street, Amsterdam, 1000 AB
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-800 pt-3 pb-6 text-center">
            <div className="flex flex-wrap justify-center items-center gap-4">
              <img
                src={bancontactLogo}
                alt="Bancontact logo"
                className="h-6 opacity-80 hover:opacity-100 hover:scale-105 transition-all duration-200"
              />
              <img
                src={idealLogo}
                alt="iDEAL logo"
